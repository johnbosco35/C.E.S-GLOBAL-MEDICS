...
const AdminDashboard = () => {
  ...
  const stats = [
    { name: 'Total Buyers', value: '2,345', change: '+12%', changeType: 'positive' },
    { name: 'Total Products', value: '156', change: '+3%', changeType: 'positive' },
    { name: 'Total Orders', value: '1,234', change: '+8%', changeType: 'positive' },
    { name: 'Revenue', value: '₦45,678,000', change: '+15%', changeType: 'positive' },
  ];
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {stats.map((stat) => (
                      <div key={stat.name} className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                        <div className="text-sm font-medium text-gray-600 dark:text-gray-300">{stat.name}</div>
